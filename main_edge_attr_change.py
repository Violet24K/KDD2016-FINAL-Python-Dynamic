...
if __name__ == '__main__':
    ...
    graph_file = open('datasets/' + DATASET_NAME + '-temporal/edge_attr_change.txt', 'r')
    ...
    for line_index in range(num_line):
        ...
        edge_attr_matrix_1[node1, node2] = change_to
        edge_attr_matrix_1[node2, node1] = change_to
        sub_change = 0
        ...
        counter += 1
        edge_attr_matrix_2[node_in_sub1, node_in_sub2] = change_to
        edge_attr_matrix_2[node_in_sub2, node_in_sub1] = change_to
